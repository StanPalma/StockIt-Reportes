    ...
    public class ReporteVentasController : Controller
    {
        ...
        public ActionResult pdfVentas()
        {
            try
            {
                ...
                string TITULO = "REPORTE GENERAL DE VENTAS";//Título a mostrar en el Encabezado
                ...
                #region Listado General de Ventas
                //Encabezado de la tabla
                PdfPTable table = new PdfPTable(5);
                float[] widths = new float[] { 8f, 40f, 30f, 12f, 10f };
                ...
                _cell = new PdfPCell(new Paragraph("FECHA DE FACTURACION", negrita));
                _cell.HorizontalAlignment = Element.ALIGN_CENTER;
                table.AddCell(_cell);
